class DetailsGood {
  String code;
  String message;
  DetailsGoodData data;

  DetailsGood({this.code, this.message, this.data});

  DetailsGood.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    data = json['data'] != null ? new DetailsGoodData.fromJson(json['data']) : null;
  }
...
class DetailsGoodData {
  GoodInfo goodInfo;
  List<GoodComments> goodComments;
  AdvertesPicture advertesPicture;

  DetailsGoodData({this.goodInfo, this.goodComments, this.advertesPicture});

  DetailsGoodData.fromJson(Map<String, dynamic> json) {
